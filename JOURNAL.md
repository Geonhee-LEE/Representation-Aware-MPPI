...
## 2026-05-25 05:00 — p2-ensemble-residual-dynamics-compat
- **Pick**: [research] Evaluate ensemble residual dynamics compatibility with MPPI parallel rollouts
- **Outcome**: FLOPs analysis confirms ensemble-3 residual (584M, 0.32× ResNet-18) fits MPPI budget; CFM ensemble (140G, 78× ResNet-18) too heavy. Recommend residual-only ensemble → P3 epistemic uncertainty channel for free.
- **Next**: (user) Install PyTorch → validate MLP CFM training convergence.
- **Full**: [`journal/2026-05/25-05-p2-ensemble-residual-dynamics-compat.md`](journal/2026-05/25-05-p2-ensemble-residual-dynamics-compat.md)
